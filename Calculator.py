...
if __name__ == "__main__": 
    ...
    for button in buttons:
        if button == '=':
            b = Button(gui, text=button, fg='black', bg='#add8e6', command=equalpress, height=1, width=7)
        elif button == '0':
            b = Button(gui, text=button, fg='black', bg='#add8e6', command=lambda: press(0), height=1, width=10)
        else:
            b = Button(gui, text=button, fg='black', bg='#add8e6', command=lambda button=button: press(button), height=1, width=7)
    ...
    # Add Clear button
    clear_button = Button(gui, text='Clear', fg='black', bg='#add8e6', command=clear, height=1, width=7)
